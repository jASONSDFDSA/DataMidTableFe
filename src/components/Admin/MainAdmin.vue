    ...
    <div>
        <el-container class="container">    
            <el-header class="header">
                ...
                <div class="header-name"><h1><el-icon><UserFilled /></el-icon>&nbsp;后台管理</h1></div>
            ...
            <el-container>
                <el-aside width="200px" class="aside">
                    ...
                    >
                        ...
                        <el-menu-item index="2" class="menu-item"><el-icon><Operation /></el-icon>权限管理</el-menu-item>
                        <el-menu-item index="3" class="menu-item"><el-icon><Avatar /></el-icon>用户管理</el-menu-item>
                        <el-menu-item index="4" class="menu-item"><el-icon><Monitor /></el-icon>平台监控</el-menu-item>
                        <el-menu-item index="5" class="menu-item"><el-icon><Files /></el-icon>SQL数据库</el-menu-item>
                        <el-menu-item index="6" class="menu-item"><el-icon><FolderOpened /></el-icon>公有数据</el-menu-item>
                        <el-menu-item index="7" class="menu-item"><el-icon><Document /></el-icon>API信息</el-menu-item>
                    </el-menu>
                </el-aside>
